...
\begin{frame}[shrink=5]{Sphere Radius: \SI{15}{mm} vs \SI{5}{mm} ($n = 69\,295$)}
  \begin{columns}[T]
    \begin{column}{0.54\textwidth}
      \vspace{-2pt}
      {\small
    ...
    \begin{column}{0.44\textwidth}
      ...
      the default — strictly dominates $r = \SI{5}{mm}$ on
      Sobel-family metrics, identical for everything else.
...
\begin{frame}{Key Findings}
  \begin{enumerate}
    ...
    \item \textbf{Radius sensitivity}: only Sobel metrics depend on
          ...
          \textbf{Recommendation}: use $r = \SI{15}{mm}$.
  \end{enumerate}
\end{frame}
...
\begin{frame}{Next Steps}
  \begin{enumerate}
    \item \textbf{Interface Severity Index (ISI)} (in development):
          ...
          BP sphere. First correlations expected next week.
