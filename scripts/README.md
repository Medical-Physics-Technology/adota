...
| [`analysis/report_gamma_acceleration.py`](analysis/report_gamma_acceleration.py) | CLI flags | Assemble the plan-level and beamlet-level gamma benchmarks into the tables, figure and CSVs of the gamma-acceleration technical report. | -- |
